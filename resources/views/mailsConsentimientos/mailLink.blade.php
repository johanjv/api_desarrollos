...
<div>
    ...
    <br>
    <div style="width: 1024px; color:#444;display:block;font-family:Georgia, Times New Roman, Times, serif;font-size:18px;line-height:100%;text-align:justify" align="center">
        ...
        <br><br>
            <h1 style="color:#444;display:block;font-family:Georgia, Times New Roman, Times, serif;font-size:22px;line-height:100%;text-align:center;margin:0 0 10px" align="center">
        ...
        <div style="background: #8080801c" >
            <p style="width: 1024px; font-style: italic; color:#444;display:block;font-family:Georgia, Times New Roman, Times, serif;font-size:16px;line-height:100%;text-align:justify" align="center">
            ...
            <p style="font-style: italic; width: 1024px; color:#444;display:block;font-family:Georgia, Times New Roman, Times, serif;font-size:16px;line-height:100%;text-align:justify" align="center">
