    ...
    public function rolesUser($usuario)
    {
        ...
        foreach ($grupos as $key => $value) {
            if ($key != 'count') {
                ...
                /* ROLES DE FACTUCONTROL */ elseif ($value == 'CN=APD_RadicadorFactu') {
                ...
                /* ROLES DE CITOLOGÍAS */ elseif ($value == 'CN=APD_ProfCitologias') {
                    array_push($rolUser, 13);
                }

                /* ROLES DE MAMITAS */ elseif ($value == 'CN=APD_Mamitas2_0') {
                    array_push($rolUser, 15);
                }

                /* ROLES DE RESIDUOS */ elseif ($value == 'CN=APD_SupAdmResiduos') {
